<template>
  <div ref="containerRef" class="line-waves-container" />
</template>
...
const props = defineProps({
  ...
  innerLineCount:         { type: Number,  default: 32.0 },
  outerLineCount:         { type: Number,  default: 36.0 },
  warpIntensity:          { type: Number,  default: 1.0 },
  rotation:               { type: Number,  default: -45 },
  edgeFadeWidth:          { type: Number,  default: 0.0 },
  colorCycleSpeed:        { type: Number,  default: 1.0 },
  brightness:             { type: Number,  default: 0.2 },
...
/* OGL inyecta el canvas dinámicamente,
   :deep() permite que el scoped lo alcance */
