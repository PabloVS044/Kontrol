...
.form-field select:focus { border-color: var(--Primary, #c9a962); }
.form-field select option { background: #0f0f0f; }
.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
.req { color: var(--Primary, #c9a962); }
.modal-actions { display: flex; justify-content: flex-end; gap: 10px; margin-top: 4px; }
.modal-error   { font-size: 12px; color: #fb7185; font-family: 'Manrope', sans-serif; }

.btn-primary {
  display: inline-flex; align-items: center; gap: 8px;
  background: var(--Primary, #c9a962); border: none; padding: 10px 18px; cursor: pointer;
