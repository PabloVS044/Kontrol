          ...
          <div v-else-if="viewMode === 'list'" class="project-list">
            ...
            <div v-if="filteredProjects.length === 0" class="empty-state">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                <rect x="6" y="10" width="28" height="22" rx="2" stroke="var(--k-shade-7)" stroke-width="1.5"/>
                <path d="M6 15h28M13 10V8M27 10V8" stroke="var(--k-shade-7)" stroke-width="1.5" stroke-linecap="square"/>
                <path d="M13 22h14M13 27h8" stroke="var(--k-shade-7)" stroke-width="1.5" stroke-linecap="square"/>
              </svg>
...
const STATUS_COLOR = {
  PLANIFICADO: '#60a5fa', /* cambiar a token color azul */
...
const statusColor    = (e) => STATUS_COLOR[e]    || 'var(--k-gray-4)'
...
.state-msg   { font-size: var(--k-font-size-body-main); color: var(--k-gray-5); }
...
.proj-subtitle      { font-size: var(--k-font-size-body-main); color: var(--k-gray-5); }
...
.btn-primary span { font-size: var(--k-font-size-caption-lg); color: var(--k-shade-1); white-space: nowrap; font-family: var(--k-font-sans); }
.btn-primary:disabled { opacity: 0.6; cursor: not-allowed; }

.icon-btn {
  width: 40px; height: 40px; border: 1px solid var(--k-shade-6); background: var(--k-shade-3);
  display: flex; align-items: center; justify-content: center; cursor: pointer;
}
.icon16 { width: 16px; height: 16px; flex-shrink: 0; }
.icon18 { width: 18px; height: 18px; flex-shrink: 0; }

.tabs { display: flex; gap: 32px; border-bottom: 1px solid var(--k-shade-6); }
.tab {
...
.section-meta    { font-size: var(--k-font-size-caption-lg); color: var(--k-gray-3); }
.section-controls { display: flex; align-items: center; gap: 10px; }

/* Search */
.search-wrap {
  display: flex; align-items: center; gap: 8px;
  border: 1px solid var(--k-shade-6); background: var(--k-shade-1);
  padding: 6px 12px; transition: border-color 0.15s;
}
.search-wrap:focus-within { border-color: rgba(var(--k-color-primary-rgb), 0.4); }
.search-icon { color: var(--k-gray-2); flex-shrink: 0; }
.search-input {
  background: var(--k-shade-3); border: none; outline: none;
  color: var(--k-color-text); font-family: var(--k-font-sans); font-size: var(--k-font-size-body-small); width: 180px;
}
.search-input::placeholder { color: var(--k-gray-2); }
.search-clear {
...
.vt-btn {
  ...
  background: var(--k-shade-3); border: none; color: var(--k-gray-2); cursor: pointer;
...
/* List view */
.project-list { display: flex; flex-direction: column; gap: 1px; background: var(--k-shade-4); }

.list-header {
  display: grid;
  grid-template-columns: 3px 1fr 150px 190px 100px 140px 80px;
  background: var(--k-shade-1);
  border-bottom: 1px solid var(--k-shade-6);
...
.list-row:hover { background: var(--k-shade-3); }
...
.lr-meta-sep { color: var(--k-shade-7); font-size: var(--k-font-size-caption-lg); flex-shrink: 0; }
.lr-desc { font-size: var(--k-font-size-caption); color: var(--k-gray-3); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }

.lr-progress-col {
  display: flex; align-items: center; gap: 8px;
  padding: 0 16px; border-left: 1px solid var(--k-shade-4);
}
.lr-bar-wrap {
  flex: 1; height: 3px; background: var(--k-shade-6); border-radius: 2px; overflow: hidden;
}
.lr-bar-fill { height: 100%; transition: width 0.4s; }
.lr-pct { font-size: var(--k-font-size-caption); color: var(--k-gray-4); width: 26px; text-align: right; flex-shrink: 0; }

.lr-budget-col {
  display: flex; align-items: center; gap: 4px;
  padding: 0 16px; border-left: 1px solid var(--k-shade-4);
  font-size: var(--k-font-size-caption-lg); color: var(--k-gray-3); white-space: nowrap; overflow: hidden;
}
.lr-budget-spent { color: var(--k-gray-5); }
.lr-budget-sep { color: var(--k-shade-7); }

.lr-due-col {
  padding: 0 16px; border-left: 1px solid var(--k-shade-4);
  font-size: var(--k-font-size-caption-lg); color: var(--k-gray-3); white-space: nowrap;
}

.lr-actions {
  display: flex; align-items: center; justify-content: center; gap: 2px;
  padding: 0 8px; border-left: 1px solid var(--k-shade-4);
}
.lr-btn {
  width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;
  background: var(--k-shade-3); border: none; color: var(--k-gray-3); cursor: pointer;
...
.card-status-text  { font-size: var(--k-font-size-body-small); letter-spacing: 0.05em; text-transform: uppercase; }
...
.progress-bg   { width: 100%; height: 4px; background: var(--k-shade-6); border-radius: 2px; overflow: hidden; }
.progress-fill { height: 100%; transition: width 0.4s; }
.progress-val  { font-size: var(--k-font-size-body-main); color: var(--k-gray-4); width: 36px; text-align: right; }

/* Budget line on project card */
.budget-line { display: flex; flex-direction: column; gap: 4px; }
.budget-labels { display: flex; justify-content: space-between; font-size: var(--k-font-size-body-main); color: var(--k-gray-5); }
.budget-val { color: var(--k-color-text); font-variant-numeric: tabular-nums; }
.budget-meta { display: flex; justify-content: space-between; align-items: center; font-size: var(--k-font-size-body-small); color: var(--k-gray-3); }
.alert-pill {
  font-size: var(--k-font-size-caption-lg); padding: 2px 8px; letter-spacing: 0.05em; border-radius: 2px;
...
.quick-btn {
  ...
  color: var(--k-gray-5); font-size: var(--k-font-size-body-main); font-family: var(--k-font-sans);
...
.due-date { font-size: var(--k-font-size-body-main); color: var(--k-gray-3); }
...
.status-select-wrap {
  ...
  gap: 8px;
  padding: 6px 12px;
  border: 1px solid var(--status-color, var(--k-gray-3));
  background: color-mix(in srgb, var(--status-color, var(--k-gray-3)) 9%, transparent);
  border-radius: 3px;
}
.status-dot-mark {
  width: 8px;
...
.status-select option { background: var(--k-shade-2); color: var(--k-color-text); }
...
.card-open {
  border-top: 1px solid var(--k-shade-4);
  padding: 10px 16px;
}
.open-link { font-size: var(--k-font-size-caption-lg); color: var(--k-gray-3); cursor: pointer; transition: color 0.15s; }
...
.modal-actions :deep(.btn) { border-radius: 0; font-family: var(--k-font-sans); font-size: var(--k-font-size-caption-lg); font-weight: 600; padding: 10px 20px; }
.modal-actions :deep(.btn:first-child) { background: var(--k-shade-3); border: 1px solid var(--k-shade-6); color: var(--k-color-text); }
.modal-actions :deep(.btn:last-child)  { background: var(--k-color-primary); color: var(--k-shade-1); }
...
.context-panel :deep(.btn) {
  ...
  font-size: var(--k-font-size-caption-lg); font-weight: 600; padding: 12px 16px;
  display: block; margin-bottom: 8px; text-align: left;
}
.context-panel :deep(.btn:first-of-type) { background: var(--k-color-primary); color: var(--k-shade-1); }
.context-panel :deep(.btn:last-of-type)  { background: var(--k-shade-3); border: 1px solid var(--k-shade-6); color: var(--k-color-text); }

.project-card.skeleton { pointer-events: none; }
.skeleton-accent { height: 3px; background: var(--k-shade-6); }
.skeleton-body   { padding: 16px; display: flex; flex-direction: column; gap: 10px; }
.skeleton-line   { height: 10px; background: var(--k-shade-4); border-radius: 2px; animation: pulse 1.4s ease-in-out infinite; }
...
.empty-title { font-family: var(--k-font-display); font-size: var(--k-font-size-heading-2); color: var(--k-gray-2); }
.empty-sub   { font-size: var(--k-font-size-body-small); color: var(--k-gray-1); }
.empty-cta   { margin-top: 4px; }

.context-panel {
  width: 320px; flex: none;
  background: var(--k-color-bg); border-left: 1px solid var(--k-shade-4);
...
.ctx-subtitle { font-size: var(--k-font-size-body-small); color: var(--k-gray-3); margin-top: 4px; }
.ctx-label    { font-size: var(--k-font-size-caption); letter-spacing: 0.1em; color: var(--k-gray-2); margin-bottom: 12px; }

.summary-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
.summary-card {
  background: var(--k-shade-2); border: 1px solid var(--k-shade-4);
  padding: 14px; display: flex; flex-direction: column; gap: 4px;
}
.s-value { font-size: var(--k-font-size-heading-1); font-weight: 700; color: var(--k-color-text); line-height: 1; }
.s-label { font-size: var(--k-font-size-caption); color: var(--k-gray-3); }
.s-sub   { font-size: var(--k-font-size-caption); color: var(--k-gray-2); }
.s-sub.gold { color: var(--k-color-primary); }
.s-sub.red  { color: var(--k-state-error-text); }

.data-source { margin-top: auto; }
.ds-label { font-size: var(--k-font-size-caption); letter-spacing: 0.1em; color: var(--k-gray-1); margin-bottom: 4px; }
.ds-text  { font-size: var(--k-font-size-caption); color: var(--k-gray-2); }

/* Modal form styles */
.modal-form  { padding: 24px; display: flex; flex-direction: column; gap: 16px; }
.form-field  { display: flex; flex-direction: column; gap: 6px; }
.form-field label { font-size: var(--k-font-size-caption); color: var(--k-gray-5); letter-spacing: 0.05em; }
.form-field input,
.form-field textarea,
.form-field select {
...
.modal-error   { font-size: var(--k-font-size-caption-lg); color: var(--k-state-error-text); }
...
@media (max-width: 900px) {
  ...
  .context-panel {
    ...
    border-left: none; border-top: 1px solid var(--k-shade-4);
