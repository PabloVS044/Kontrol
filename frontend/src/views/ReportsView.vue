...
.kpi-badge--green  { background: #4ade80;  color: #4ade80; }
.kpi-badge--purple { background: #a78bfa; color: #a78bfa; }
.kpi-badge--red    { background: #fb7185; color: #fb7185; }
...
.btn-primary:hover:not(:disabled) { background: #c9a962; }
